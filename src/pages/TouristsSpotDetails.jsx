        ...
        <div className="my-8">
            ...
            <div className="overflow-hidden">
                <div className="flex gap-6 justify-between items-center flex-col md:flex-row mb-10">
                    <div className="md:text-left text-center">
                        ...
                        <div className="flex flex-wrap md:justify-start justify-center items-center gap-2">
                            ...
                            <p>Added by <span className="text-blue-800 dark:text-blue-400 font-medium"><a href={`mailto:${spot.userEmail}`}>{spot.userName}</a></span></p>
                        </div>
                    </div>
                    <div>
                        <button className="btn btn-secondary bg-indigo-600 hover:bg-indigo-700 border-0 !text-base hover:border-0 dark:text-white">Book Now</button>
                    </div>
                </div>
                ...
                <div className="flex md:flex-row flex-col flex-wrap text-center justify-center gap-6">
                    <div className="bg-white dark:bg-slate-950 flex-1 rounded-md p-4 items-center justify-center flex flex-col gap-2">
                    ...
                    <div className="bg-white dark:bg-slate-950 rounded-md p-4 flex-1 items-center justify-center flex flex-col gap-2">
                ...
                <div className="mt-10">
                    ...
                    <p className="text-gray-800 dark:text-gray-400">{spot.short_description}</p>
                </div>
            </div>
        </div>
