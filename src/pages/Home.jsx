                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div className="mt-4 text-gray-700 dark:text-gray-400">
                            ...
                            <ul className="ml-7 mb-2 dark:text-gray-300 text-gray-900 list-disc font-medium">
                                <li>Jungle treks</li>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                    <div className="bg-white dark:bg-slate-950 rounded-lg shadow-md overflow-hidden">
                        <div className="p-6">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">Our experienced guides are passionate about sharing their knowledge and ensuring you have a memorable journey.</p>
                        </div>
                    </div>
                    <div className="bg-white dark:bg-slate-950 rounded-lg shadow-md overflow-hidden">
                        <div className="p-6">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">We tailor each experience to your preferences, ensuring every moment is personalized and unforgettable.</p>
                        </div>
                    </div>
                    <div className="bg-white dark:bg-slate-950 rounded-lg shadow-md overflow-hidden">
                        <div className="p-6">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">Your safety is our top priority, with rigorous safety measures and expert guidance every step of the way.</p>
                        </div>
                    </div>
                </div>
            </div>
